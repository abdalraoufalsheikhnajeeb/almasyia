...
//     nameRU: "Абу-Даби",
//     src: "/images/chapters/.webp",
//     descriptionAR: "عاصمة دولة ا إ لإمارات العربية المتحدة، وتقع على جزيرة آبو ظ ب، وتمتد
// يطة و هي آكبر ا إ لإمارات الس بع، وتضم ا إ لإمارة 􀟾 إ الى اليابسة والجزر ا
// مدينة آبو ظب عاصمة الدولة الاتحادية، كما تملك آكبر خط ساحلي
// مقا ن رة با إ لإمارات ا لخرى والذي يمتد من إ امارة دبي شمالإً حتى دولة قطر
// غرباً، سميت عاصمة دولة ا إ لإمارات آبو ظب بهذا الاسم نس بة إ الى ظب
// صغير قاد قبيلةً تائهة إ الى المياه العذبة في جزيرة لإ يزيد عدد آكواخ سعف
// النخيل )باراس تي( فيها على 300 نخلة، مع بضعة آبنية مرجانية وحصن
// الحاكم. وقد تحوّلت هذه الجزيرة البس يطة وتطوّرت تركيبتها السكّّنية مع
// الوقت، وهي اليوم مدينة آبو ظب العصرية العالمية وعاصمة ا إ لإمارات
// العربية المتّحدة ذات المباني شاهقة الارتفاع. يمزج هذا ا لرخبيل الرائع
// بين التاريخ القديم والثقافة العريقة والتراث الغني والطبيعة الخلابة والشواطئ الجميلة والرفاهية الراقية والحياة البرية المدهشة والمغامرات العائلية ومرافق
// التسوق العالمية وملاعب الجولف الشهيرة وا لجواء الرحبة المميزة",
//     descriptionEN: "The capital of the United Arab Emirates, it is located on the island of Abu Dhabi, and extends
// It is the largest of the seven emirates, and includes the mainland and islands of the Emirate.
// The city of Abu Dhabi is the capital of the federal state, and it also has the largest coastline
// Compared to other emirates, which extends from the Emirate of Dubai in the north to the State of Qatar.
// To the west, the capital of the Emirates, Abu Dhabi, was named after a deer.
// A small man led a lost tribe to the fresh waters of an island with no more than one palm huts
// The palm trees (Paras Tea) contain over 300 palm trees, with a few coral buildings and a fort
// the ruler. This simple island has been transformed and its residential structure has developed
// Time, and today it is the modern, cosmopolitan city of Abu Dhabi and the capital of the Emirates
// United Arab Emirates high-rise buildings. This wonderful archipelago blends...
// Between ancient history, ancient culture, rich heritage, stunning nature, beautiful beaches, refined luxury, amazing wildlife, family adventures and facilities
// International shopping, famous golf courses, and a distinctive welcoming atmosphere",
//     descriptionRU: "Высотные здания Объединенных Арабских Эмиратов. Этот чудесный архипелаг сочетает в себе...
// ",
//   },
//   {
//     nameAR: "برج خليفة",
...
//     nameEN: "Abu Dhabi Corniche",
//     nameRU: "Набережная Абу-Даби",
//     src: "/images/chapters/.webp",
//     descriptionAR: "",
//     descriptionEN: "",
//     descriptionRU: "",
...
// Hotel website
// https://palacebridge.ru/Located in the 5-star Solo Sokos Palace Bridge Hotel near Palace Bridge, St. Petersburg Hotel features a gift shop and luggage storage. There is private parking for RUB 1800 for one day on site for all guests at the property in Saint Petersburg. You will be within about a 25-minute walk from Palace Square and within about a 25-minute walk from the Church of the Savior on Blood. Cultural attractions in the area include the Hermitage Museum (1.9 km) and the Russian Museum (2.3 km). You can easily find Mars Square within about 25 minutes' walk from this hotel. Solo Sokos Palace Bridge Hotel is located near Vaselostrovskaya Metro Station, about 10 minutes on foot.
// Hotel website
// https://palacebridge.ru/",
