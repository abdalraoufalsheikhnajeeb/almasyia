...
if (lang === "en") {
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        <table className="w-fit text-left text-gray-700">
          <tbody>
            ...
            <tr className="border-b">
              <td className="font-semibold py-2 pe-8">Owner</td>
            ...
            <tr className="border-b">
              <td className="font-semibold py-2 pe-8">Year of Operation</td>
              <td className="py-2">2009</td>
            </tr>
            <tr className="border-b">
              <td className="font-semibold py-2 pe-8">Website</td>
              <td className="py-2">
    ...
    return (
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        <p className="text-gray-700 mb-4">
          يتكون أسطول الشركة بشكل أساسي من طائرات بوينغ 737-800 وبوينغ 737 ماكس.
          تم تجهيز هذه الطائرات الحديثة بميزات أمان متقدمة وتوفر تجربة سفر مريحة.
        </p>
        ...
        <p className="text-gray-700 mb-4">
          ...
          ذلك الترفيه على متن الطائرة، خيارات الوجبات، والمقاعد المريحة.
          يتمتع ركاب درجة رجال الأعمال بمزايا إضافية مثل المقاعد الفسيحة،
          الوجبات الفاخرة، وأولوية الصعود إلى الطائرة.
        </p>
        <h2 className="text-2xl font-semibold mb-2">تجربة السفر</h2>
        <p className="text-gray-700 mb-4">
          يمكن للركاب الاستمتاع بمجموعة متنوعة من خيارات الترفيه على متن
          الطائرة، بما في ذلك الأفلام، البرامج التلفزيونية، الموسيقى، والألعاب.
          كما توفر الشركة الواي فاي على بعض الرحلات، مما يسمح للركاب بالبقاء
          متصلين أثناء رحلتهم.
        </p>
        ...
        <p className="text-gray-700 mb-4">
          ...
          الحجوزات، الاستفسارات، والطلبات الخاصة. توفر الشركة أيضًا خدمة
        ...
        <h2 className="text-2xl font-semibold mb-4">معلومات عامة عن فلاي دبي</h2>
        <table className="w-fit text-left text-gray-700">
          <tbody>
            <tr className="border-b">
            ...
            <tr className="border-b">
              <td className="font-semibold py-2 pe-8">سنة التشغيل</td>
              <td className="py-2">2009</td>
            </tr>
            <tr className="border-b">
              <td className="font-semibold py-2 pe-8">الموقع الإلكتروني</td>
              <td className="py-2">
                <a href="https://www.flydubai.com" className="text-blue-500">
                  www.flydubai.com
                </a>
            ...
            <tr className="border-b">
              <td className="font-semibold py-2 pe-8">رقم خدمة العملاء</td>
              <td className="py-2">
                <a href="tel:+971600544445" className="text-blue-500">
                  +971600544445
                </a>
  ...
  <div className="bg-white shadow-md rounded-lg p-6">
    ...
    />
    <p className="text-gray-700 mb-4">
      Flydubai, официально известная как Dubai Aviation Corporation, является
      государственной авиакомпанией с низкими тарифами в Дубае, Объединенные
      Арабские Эмираты. Основана в 2008 году, Flydubai выполняет рейсы более чем в 90 пунктов назначения
      на Ближнем Востоке, в Африке, Азии и Европе.
    </p>
    <h2 className="text-2xl font-semibold mb-2">История</h2>
    <p className="text-gray-700 mb-4">
      Flydubai была основана для поддержки коммерческих и туристических секторов Дубая
      предоставлением доступных и недорогих вариантов авиаперелетов. С момента
      своего создания авиакомпания быстро расширила свою маршрутную сеть и флот.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Флот</h2>
    <p className="text-gray-700 mb-4">
      Флот авиакомпании в основном состоит из самолетов Boeing 737-800 и Boeing
      737 MAX. Эти современные самолеты оснащены передовыми
      функциями безопасности и обеспечивают комфортные условия для путешествий.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Пункты назначения</h2>
    <p className="text-gray-700 mb-4">
      Flydubai обслуживает широкий спектр пунктов назначения, включая крупные города
      и популярные места для отдыха на Ближнем Востоке, в Африке, Азии и
      Европе. Ключевые пункты назначения включают Дубай, Бейрут, Баку, Катманду,
      Тбилиси и Занзибар.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Услуги</h2>
    <p className="text-gray-700 mb-4">
      Flydubai предлагает различные услуги для улучшения качества путешествий, включая
      развлекательные программы на борту, варианты питания и
      удобные сиденья. Пассажиры бизнес-класса пользуются дополнительными
      удобствами, такими как просторные сиденья, премиальные блюда и приоритетная посадка.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Опыт полета</h2>
    <p className="text-gray-700 mb-4">
      Пассажиры могут наслаждаться различными развлекательными программами на борту,
      включая фильмы, телешоу, музыку и игры. Авиакомпания также
      предоставляет Wi-Fi на некоторых рейсах, позволяя пассажирам оставаться
      на связи во время путешествия.
    </p>
    ...
    <p className="text-gray-700 mb-4">
      ...
      баллами, которые можно обменять на билеты, апгрейды и другие преимущества.
      Участники пользуются такими привилегиями, как приоритетная регистрация, дополнительный багаж и
      эксклюзивные предложения.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Бронирование и обслуживание клиентов</h2>
    <p className="text-gray-700 mb-4">
      Бронирование рейсов с Flydubai легко осуществляется через их официальный сайт,
      мобильное приложение и авторизованных туристических агентов. Команда обслуживания клиентов
      доступна для помощи с бронированием, запросами и специальными
      запросами. Авиакомпания также предлагает онлайн-регистрацию и мобильные
      посадочные талоны.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Корпоративная социальная ответственность</h2>
    <p className="text-gray-700 mb-4">
      Flydubai стремится к устойчивым практикам и поддержке местных сообществ. Авиакомпания участвует
      в различных инициативах КСО, включая усилия по сохранению окружающей среды, образовательные программы и благотворительные партнерства.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Контактная информация</h2>
    <p className="text-gray-700">
      Для получения дополнительной информации или бронирования рейса посетите официальный сайт Flydubai
      или свяжитесь с их службой поддержки клиентов по телефону +971 600 544 445. Следите за ними в социальных сетях, чтобы получать последние обновления и акции.
    </p>
    <h2 className="text-2xl font-semibold mb-4">Общая информация о Flydubai</h2>
    <table className="w-fit text-left text-gray-700">
      <tbody>
        <tr className="border-b">
        ...
        <tr className="border-b">
          <td className="font-semibold py-2 pe-8">Год начала операций</td>
          <td className="py-2">2009</td>
        </tr>
        <tr className="border-b">
          <td className="font-semibold py-2 pe-8">Вебсайт</td>
          <td className="py-2">
            <a href="https://www.flydubai.com" className="text-blue-500">
              www.flydubai.com
            </a>
        ...
        <tr className="border-b">
          <td className="font-semibold py-2 pe-8">Номер службы поддержки</td>
          <td className="py-2">
            <a href="tel:+971600544445" className="text-blue-500">
              +971600544445
            </a>
