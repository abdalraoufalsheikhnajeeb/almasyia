...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/airLinesBrief/FlyDubai",
    title: AIRLINES_SEO.FlyDubai.title,
    description: AIRLINES_SEO.FlyDubai.description,
    imageUrl: "/images/flyDubai.webp",
  });
}
      ...
      <div className="container mx-auto p-4">
        <div className="bg-white shadow-md rounded-lg p-4 opacity-85 flex flex-col max-w-7xl mx-auto pt-24">
          ...
          <p className="text-primary">
            ...
            أو تواصل مع مكتبنا للحجز على +971 54 586 6066. تابعهم على وسائل
