  ...
  if (lang == "en")
    ...
    return (
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        />
        <p className="text-gray-700 mb-4">
          Авиакомпания Cham Wings — частная сирийская авиакомпания, основанная в 2007 году.
          Она выполняет регулярные и чартерные рейсы по Ближнему Востоку, Европе и Северной
          Африке. Авиакомпания стремится предоставлять услуги высокого качества и
          комфортные условия путешествий для своих пассажиров.
        </p>
        <h2 className="text-2xl font-semibold mb-2">История</h2>
        <p className="text-gray-700 mb-4">
          Авиакомпания Cham Wings была создана для удовлетворения растущего спроса на
          авиаперевозки в Сирии и соседних регионах. За эти годы она расширила свою сеть и
          парк воздушных судов, став значимым игроком на региональном авиационном рынке.
        </p>
        <h2 className="text-2xl font-semibold mb-2">Парк воздушных судов</h2>
        <p className="text-gray-700 mb-4">
          Парк воздушных судов авиакомпании включает современные самолеты Airbus A320,
          известные своей надежностью и комфортом. Самолеты оснащены передовыми системами
          безопасности и удобствами для улучшения пассажирского опыта. Регулярное
          техническое обслуживание и обновления обеспечивают соответствие парка самым
          высоким стандартам безопасности.
        </p>
        <h2 className="text-2xl font-semibold mb-2">Направления</h2>
        <p className="text-gray-700 mb-4">
          Авиакомпания Cham Wings обслуживает различные направления, включая крупные города
          Ближнего Востока, Европы и Северной Африки. Некоторые ключевые направления
          включают Дубай, Бейрут, Кувейт, Багдад, Хартум и Ереван. Авиакомпания постоянно
          оценивает и добавляет новые маршруты в зависимости от спроса пассажиров и
          рыночных возможностей.
        </p>
        <h2 className="text-2xl font-semibold mb-2">Услуги</h2>
        <p className="text-gray-700 mb-4">
          Авиакомпания предлагает ряд услуг для обеспечения комфорта и удовлетворенности
          пассажиров. В это входят развлекательные системы на борту, варианты питания и
          различные схемы рассадки для удовлетворения потребностей различных пассажиров.
          Также доступны специальные услуги помощи для пассажиров с ограниченными
          возможностями или особыми требованиями.
        </p>
        <h2 className="text-2xl font-semibold mb-2">Впечатления на борту</h2>
        <p className="text-gray-700 mb-4">
          Пассажиры могут насладиться приятным опытом полета с авиакомпанией Cham Wings.
          Авиакомпания предлагает выбор фильмов, музыки и игр в рамках своей системы
          развлечений на борту. Питание готовится из качественных ингредиентов с учетом
          различных диетических предпочтений.
        </p>
        <h2 className="text-2xl font-semibold mb-2">Программа лояльности</h2>
        <p className="text-gray-700 mb-4">
          Авиакомпания Cham Wings имеет программу лояльности, которая вознаграждает
          постоянных клиентов различными преимуществами, такими как приоритетная посадка,
          дополнительное разрешенное количество багажа и доступ в эксклюзивные залы.
          Участники могут зарабатывать очки за каждый полет и обменивать их на награды и
          скидки.
        </p>
        <h2 className="text-2xl font-semibold mb-2">Бронирование и обслуживание клиентов</h2>
        <p className="text-gray-700 mb-4">
          Бронирование рейсов с авиакомпанией Cham Wings удобно через их официальный сайт,
          мобильное приложение и авторизованных туристических агентов. Команда
          обслуживания клиентов доступна круглосуточно для помощи с бронированиями,
          запросами и особыми требованиями. Авиакомпания также предлагает удобную услугу
        ...
        <p className="text-gray-700 mb-4">
          Авиакомпания Cham Wings стремится вносить положительный вклад в общество. Компания
          участвует в различных инициативах корпоративной социальной ответственности,
          включая усилия по охране окружающей среды, поддержку местных сообществ и участие в
          гуманитарных миссиях.
        </p>
        <h2 className="text-2xl font-semibold mb-2">Контактная информация</h2>
        <p className="text-gray-700">
          Для получения дополнительной информации или бронирования рейса вы можете
          посетить официальный сайт авиакомпании Cham Wings или связаться со службой
          поддержки клиентов по телефону +963 11 9999. Следите за ними в социальных сетях
          для получения последних обновлений и акций.
        </p>
      </div>
    </div>
