...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/airLinesBrief/singapore-airlines",
    title: AIRLINES_SEO["singapore-airlines"].title,
    description: AIRLINES_SEO["singapore-airlines"].description,
    imageUrl: "/images/singapore-airlines.webp",
  });
}
