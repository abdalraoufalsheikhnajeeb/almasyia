...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/airLinesBrief/British-Airways",
    title: AIRLINES_SEO["British-Airways"].title,
    description: AIRLINES_SEO["British-Airways"].description,
    imageUrl: "/images/britishAirways.webp",
  });
}
