...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/airLinesBrief/etihad-airways",
    title: AIRLINES_SEO["etihad-airways"].title,
    description: AIRLINES_SEO["etihad-airways"].description,
    imageUrl: "/images/etihadairways.webp",
  });
}
  ...
  if (lang === "en") {
    return (
      <div className="container mx-auto p-4">
        <div className="bg-white shadow-md rounded-lg p-4 opacity-85 flex flex-col max-w-7xl mx-auto pt-24 pt-24">
