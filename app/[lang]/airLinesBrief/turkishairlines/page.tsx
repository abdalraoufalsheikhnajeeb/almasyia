...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/airLinesBrief/turkishairlines",
    title: AIRLINES_SEO.turkishairlines.title,
    description: AIRLINES_SEO.turkishairlines.description,
    imageUrl: "/images/turkishairlines.webp",
  });
}
      ...
      <div className="container mx-auto p-4">
        <div className="bg-white shadow-md rounded-lg p-4 opacity-85 flex flex-col max-w-7xl mx-auto pt-24">
          ...
          <p className="text-primary">
            ...
            +الجوية التركية أو اتصل بخدمة العملاء على الرقم 971545866066 .
