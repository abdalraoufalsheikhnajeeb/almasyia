...
if (lang === "en") {
  ...
  <div className="bg-white shadow-md rounded-lg p-6">
    ...
    />
    <p className="text-gray-700 mb-4">
      خطوط إس 7 الجوية، والمعروفة أيضًا باسم خطوط سيبيريا الجوية، هي شركة طيران
      روسية كبرى مقرها في نوفوسيبيرسك. تأسست في عام 1957، وتدير رحلات داخلية
      ودولية إلى أكثر من 150 وجهة عبر أوروبا وآسيا والشرق الأوسط.
    </p>
    <h2 className="text-2xl font-semibold mb-2">التاريخ</h2>
    <p className="text-gray-700 mb-4">
      تأسست خطوط إس 7 الجوية في عام 1957 ونمت لتصبح واحدة من الشركات الرائدة في
      روسيا. انضمت الشركة إلى تحالف ون وورلد في عام 2010، مما عزز من وصولها
      واتصالها العالمي.
    </p>
    <h2 className="text-2xl font-semibold mb-2">الأسطول</h2>
    <p className="text-gray-700 mb-4">
      يتكون أسطول الشركة من مزيج من طائرات إيرباص وبوينغ الحديثة، مثل إيرباص A320،
      إيرباص A321، وبوينغ 737. تشتهر خطوط إس 7 الجوية بالحفاظ على أسطول شاب وفعال.
    </p>
    <h2 className="text-2xl font-semibold mb-2">الوجهات</h2>
    <p className="text-gray-700 mb-4">
      تخدم خطوط إس 7 الجوية مجموعة واسعة من الوجهات عبر أوروبا وآسيا والشرق الأوسط.
      تشمل الوجهات الرئيسية موسكو، سانت بطرسبرغ، بكين، بانكوك، دبي وطوكيو.
    </p>
    <h2 className="text-2xl font-semibold mb-2">الخدمات</h2>
    <p className="text-gray-700 mb-4">
      تقدم الشركة مجموعة متنوعة من الخدمات لضمان تجربة سفر عالية الجودة. يتضمن ذلك
      الترفيه على متن الطائرة، خيارات الوجبات، والمقاعد المريحة. يتمتع ركاب درجة
      رجال الأعمال بمزايا إضافية مثل المقاعد المسطحة، الطعام الفاخر، والوصول إلى
      الصالات الحصرية.
    </p>
    ...
    <p className="text-gray-700 mb-4">
      برنامج الولاء من خطوط إس 7 الجوية، S7 Priority، يكافئ العملاء المخلصين
      بالأميال التي يمكن استبدالها برحلات جوية، ترقيات، ومزايا أخرى. يتمتع
      الأعضاء بمزايا مثل أولوية تسجيل الدخول، وزن أمتعة إضافي، والوصول إلى الصالات
      الحصرية.
    </p>
    <h2 className="text-2xl font-semibold mb-2">الحجز وخدمة العملاء</h2>
    <p className="text-gray-700 mb-4">
      يمكن حجز الرحلات مع خطوط إس 7 الجوية بسهولة عبر موقعها الرسمي، التطبيق المحمول،
      والوكلاء المعتمدين. فريق خدمة العملاء متاح للمساعدة في الحجوزات، الاستفسارات،
      والطلبات الخاصة. توفر الشركة أيضًا خدمة تسجيل الدخول عبر الإنترنت وخيارات
      بطاقة الصعود المحمولة.
    </p>
    <h2 className="text-2xl font-semibold mb-2">المسؤولية الاجتماعية</h2>
    <p className="text-gray-700 mb-4">
      تلتزم خطوط إس 7 الجوية بالممارسات المستدامة ودعم المجتمعات المحلية. تشارك
      الشركة في مبادرات المسؤولية الاجتماعية المختلفة، بما في ذلك جهود الحفاظ على
      البيئة، برامج التعليم، والشراكات الخيرية.
    </p>
    <h2 className="text-2xl font-semibold mb-2">معلومات الاتصال</h2>
    <p className="text-gray-700">
      لمزيد من المعلومات أو لحجز رحلة، قم بزيارة الموقع الرسمي لخطوط إس 7 الجوية
      أو اتصل بخدمة العملاء على الرقم +7 495 783 0707. تابعهم على وسائل التواصل
  ...
  <div className="bg-white shadow-md rounded-lg p-6">
    ...
    />
    <p className="text-gray-700 mb-4">
      Авиакомпания S7, также известная как Сибирь, является крупной российской
      авиакомпанией со штаб-квартирой в Новосибирске. Основанная в 1957 году, она
      выполняет внутренние и международные рейсы более чем в 150 пунктов назначения
      в Европе, Азии и на Ближнем Востоке.
    </p>
    <h2 className="text-2xl font-semibold mb-2">История</h2>
    <p className="text-gray-700 mb-4">
      Авиакомпания S7 была основана в 1957 году и с тех пор выросла и стала одной
      из ведущих авиакомпаний России. Авиакомпания присоединилась к альянсу oneworld
      в 2010 году, что улучшило ее глобальную связанность.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Флот</h2>
    <p className="text-gray-700 mb-4">
      Флот авиакомпании состоит из современных самолетов Airbus и Boeing, таких как
      Airbus A320, Airbus A321 и Boeing 737. S7 Airlines известна поддержанием
      молодого и эффективного флота.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Пункты назначения</h2>
    <p className="text-gray-700 mb-4">
      Авиакомпания S7 обслуживает широкий спектр направлений в Европе, Азии и на
      Ближнем Востоке. Основные направления включают Москву, Санкт-Петербург, Пекин,
      Бангкок, Дубай и Токио.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Услуги</h2>
    <p className="text-gray-700 mb-4">
      Авиакомпания предлагает различные услуги для обеспечения высокого качества
      путешествий. Это включает в себя развлекательные программы на борту, варианты
      питания и удобные сиденья. Пассажиры бизнес-класса пользуются дополнительными
      удобствами, такими как раскладывающиеся сиденья, премиальное питание и доступ
      в эксклюзивные залы ожидания.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Опыт полета</h2>
    <p className="text-gray-700 mb-4">
      Пассажиры могут наслаждаться современными развлекательными системами на борту
      с широким выбором фильмов, телешоу, музыки и игр. Авиакомпания также предоставляет
      Wi-Fi на многих своих рейсах, позволяя пассажирам оставаться на связи.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Программа лояльности</h2>
    <p className="text-gray-700 mb-4">
      Программа лояльности авиакомпании S7, S7 Priority, вознаграждает лояльных
      клиентов милями, которые можно обменять на билеты, апгрейды и другие
      преимущества. Участники пользуются такими привилегиями, как приоритетная
      регистрация, дополнительный багаж и доступ в эксклюзивные залы ожидания.
    </p>
    ...
    <p className="text-gray-700 mb-4">
      ...
      официальный сайт, мобильное приложение и авторизованных туристических агентов.
      Команда обслуживания клиентов доступна для помощи с бронированием, запросами
      и специальными запросами. Авиакомпания также предлагает удобные варианты
      онлайн-регистрации и мобильные посадочные талоны.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Корпоративная социальная ответственность</h2>
    <p className="text-gray-700 mb-4">
      Авиакомпания S7 стремится к устойчивым практикам и поддержке местных сообществ.
      Авиакомпания участвует в различных инициативах КСО, включая усилия по
      сохранению окружающей среды, образовательные программы и благотворительные
      партнерства.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Контактная информация</h2>
    <p className="text-gray-700">
      Для получения дополнительной информации или бронирования рейса посетите
      официальный сайт авиакомпании S7 или свяжитесь с их службой поддержки клиентов
      по телефону +7 495 783 0707. Следите за ними в социальных сетях, чтобы
      получать последние обновления и акции.
    </p>
  </div>
</div>
