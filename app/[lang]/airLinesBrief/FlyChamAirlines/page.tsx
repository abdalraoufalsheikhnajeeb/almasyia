    ...
    return (
      <div className="container mx-auto p-4">
        <div className="bg-white shadow-md rounded-lg p-4 opacity-85 flex flex-col max-w-7xl mx-auto pt-24">
          <h1 className="text-4xl text-center font-bold">فلاي شام للطيران</h1>
          <Image
            width={420}
            height={300}
            quality={60}
    ...
    return (
      <div className="container mx-auto p-4">
        <div className="bg-white shadow-md rounded-lg p-4 opacity-85 flex flex-col max-w-7xl mx-auto pt-24">
          ...
          />
          <p className="text-primary mb-4">
            طيران فلاي شام هو شركة طيران خاصة سورية تأسست في عام 2007. تقوم
          ...
          <p className="text-primary mb-4">
            تم تأسيس شركة طيران فلاي شام لتلبية الطلب المتزايد على السفر الجوي
            في سوريا والمنطقة المحيطة. على مر السنين، وسعت شبكتها وأسطولها،
            لتصبح لاعبًا رئيسيًا في سوق الطيران الإقليمي.
          </p>
          ...
          <p className="text-primary mb-4">
            تخدم طيران فلاي شام مجموعة متنوعة من الوجهات بما في ذلك المدن
          ...
          <p className="text-primary mb-4">
            يمكن للركاب الاستمتاع بتجربة طيران ممتعة مع طيران فلاي شام. تقدم
          ...
          <p className="text-primary mb-4">
            لدى طيران فلاي شام برنامج ولاء يكافئ العملاء المخلصين بمزايا مختلفة،
            مثل الأولوية في الصعود إلى الطائرة، زيادة الوزن المسموح به للأمتعة،
            والدخول إلى الصالات الحصرية. يمكن للأعضاء كسب النقاط مع كل رحلة
            واستبدالها بمكافآت وخصومات.
          </p>
          <h2 className="text-2xl font-bold mb-2">الحجز وخدمة العملاء</h2>
          <p className="text-primary mb-4">
            يمكن حجز الرحلات مع طيران فلاي شام بسهولة من خلال موقعهم الرسمي،
          ...
          <p className="text-primary mb-4">
            تلتزم شركة طيران فلاي شام بالمساهمة بشكل إيجابي في المجتمع. تشارك
          ...
          <p className="text-primary">
            ...
            فلاي شام أو الاتصال بخدمة العملاء على الرقم +963 11 9999. تابعوهم
            ...
            <table className="w-fit text-start text-primary">
              <tbody>
                ...
                <tr className="border-b">
                  ...
                  <td className="py-2">فلاي شام للطيران</td>
                </tr>
                <tr className="border-b">
