...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/airLinesBrief/Saudia",
    title: AIRLINES_SEO.Saudia.title,
    description: AIRLINES_SEO.Saudia.description,
    imageUrl: "/images/saudia.webp",
  });
}

const SaudiaAir = async ({ params }: { params: Promise<{ lang: string }> }) => {
