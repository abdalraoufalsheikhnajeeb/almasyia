          ...
          <div>
            ...
            <table className="w-fit text-left text-gray-700">
              <tbody>
                ...
                <tr className="border-b">
                  <td className="font-semibold py-2 pe-8">Main Company</td>
                ...
                <tr className="border-b">
                  <td className="font-semibold py-2 pe-8">Logo</td>
                  <td className="py-2">"Welcome to your world"</td>
                </tr>
                <tr className="border-b">
                  <td className="font-semibold py-2 pe-8">Alliances</td>
                  <td className="py-2">
          ...
          <div>
            ...
            <table className="w-fit text-left text-gray-700">
              <tbody>
                ...
                <tr className="border-b">
                  <td className="font-semibold py-2 pe-8">الشركة الرئيسية</td>
                ...
                <tr className="border-b">
                  <td className="font-semibold py-2 pe-8">الشعار</td>
                  <td className="py-2">"مرحبا بكم في عالمكم"</td>
                </tr>
                <tr className="border-b">
                  <td className="font-semibold py-2 pe-8">التحالفات</td>
                  <td className="py-2">
          ...
          <div>
            ...
            <table className="w-fit text-left text-gray-700">
              <tbody>
                ...
                <tr className="border-b">
                  <td className="font-semibold py-2 pe-8">Основная компания</td>
                  <td className="py-2">Saudi Arabian Airlines</td>
                </tr>
                <tr className="border-b">
                  <td className="font-semibold py-2 pe-8">
                ...
                <tr className="border-b">
                  <td className="font-semibold py-2 pe-8">Слоган</td>
                  <td className="py-2">"Добро пожаловать в ваш мир"</td>
                </tr>
                <tr className="border-b">
                  <td className="font-semibold py-2 pe-8">Альянсы</td>
                  <td className="py-2">
                    Sky Team Alliance - "Shared Code" Alliance
                  </td>
                </tr>
