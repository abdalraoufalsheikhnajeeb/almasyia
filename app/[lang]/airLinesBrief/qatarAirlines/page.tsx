        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <table className="w-fit text-left text-gray-700">
            <tbody>
              ...
              <tr className="border-b">
                <td className="font-semibold py-2 pe-8">Establishment Year</td>
                <td className="py-2">1994</td>
              </tr>
              <tr className="border-b">
                <td className="font-semibold py-2 pe-8">Fleet size</td>
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <table className="w-fit text-left text-gray-700">
            <tbody>
              ...
              <tr className="border-b">
                <td className="font-semibold py-2 pe-8">حجم الأسطول</td>
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <table className="w-fit text-left text-gray-700">
            <tbody>
              ...
              <tr className="border-b">
                <td className="font-semibold py-2 pe-8">Размер флота</td>
