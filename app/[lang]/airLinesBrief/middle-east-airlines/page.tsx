...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/airLinesBrief/middle-east-airlines",
    title: AIRLINES_SEO["middle-east-airlines"].title,
    description: AIRLINES_SEO["middle-east-airlines"].description,
    imageUrl: "/images/middleeastairlines.webp",
  });
}
