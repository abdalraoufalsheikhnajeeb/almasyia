...
const EgyptAir = async ({ params: { lang } }: { params: { lang: Locale } }) => {
  if (lang === "en") {
    return (
      <div className="container mx-auto p-4">
        <div className="bg-white shadow-md rounded-lg p-6 max-w-7xl mx-auto">
          ...
          <p className="text-gray-700">
            ...
            EgyptAir website or contact their customer service at +20 2 2265
      ...
      <div className="container mx-auto p-4">
        <div className="bg-white shadow-md rounded-lg p-6 max-w-7xl mx-auto">
          ...
          <p className="text-gray-700">
            ...
            للطيران أو اتصل بخدمة العملاء على الرقم +20 2 2265 0000. تابعهم على
      ...
      <div className="container mx-auto p-4">
        <div className="bg-white shadow-md rounded-lg p-6 max-w-7xl mx-auto">
          ...
          <p className="text-gray-700">
            ...
            поддержки клиентов по телефону +20 2 2265 0000. Следите за ними в
