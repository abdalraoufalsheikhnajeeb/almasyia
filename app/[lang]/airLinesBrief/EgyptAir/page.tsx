...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/airLinesBrief/EgyptAir",
    title: AIRLINES_SEO.EgyptAir.title,
    description: AIRLINES_SEO.EgyptAir.description,
    imageUrl: "/images/egyptair.webp",
  });
}

const EgyptAir = async ({ params }: { params: Promise<{ lang: string }> }) => {
