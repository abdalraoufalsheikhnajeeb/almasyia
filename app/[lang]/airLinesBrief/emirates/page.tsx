...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/airLinesBrief/emirates",
    title: AIRLINES_SEO.emirates.title,
    description: AIRLINES_SEO.emirates.description,
    imageUrl: "/images/emirates.webp",
  });
}

const Emirates = async ({ params }: { params: Promise<{ lang: string }> }) => {
