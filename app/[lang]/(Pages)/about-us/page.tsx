...
const aboutText: Record<Locale, { heading: string; tagline: string; body: string }> = {
  en: {
    heading: "About AlNujoom AlMasiya",
  ...
  ru: {
    heading: "О компании AlNujoom AlMasiya",
        ...
        <div className="grid gap-0 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-5 p-8 lg:p-12">
            <Image
              ...
              className="h-20 w-auto self-start object-contain lg:h-24"
            ...
            <div>
              <h1 className="heading-accent text-3xl font-bold text-primary lg:text-4xl">
                {content.heading}
              </h1>
