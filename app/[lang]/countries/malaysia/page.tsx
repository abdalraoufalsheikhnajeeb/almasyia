...
import { Malaysia } from "../../destinations/Malaysia";
...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    ...
    title: COUNTRIES_SEO.malaysia.title,
    description: COUNTRIES_SEO.malaysia.description,
    imageUrl: "/images/malaysia.webp",
  });
}
...
const page = async ({ params }: { params: Promise<{ lang: string }> }) => {
  ...
  const jsonLd = buildCountryJsonLd({
    name: COUNTRIES_SEO.malaysia.title[lang],
    description: COUNTRIES_SEO.malaysia.description[lang],
    imageUrl: "/images/malaysia.webp",
    pageUrl: `${SITE_URL}/${lang}/countries/malaysia`,
  });
  const heading =
    lang === "ar" ? "السفر إلى ماليزيا" : lang === "ru" ? "Путешествие в Малайзию" : "Travel to Malaysia";
  return (
