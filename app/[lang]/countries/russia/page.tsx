...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    ...
    title: COUNTRIES_SEO.russia.title,
    description: COUNTRIES_SEO.russia.description,
    imageUrl: "/images/Russia.webp",
  });
}
...
const page = async ({ params }: { params: Promise<{ lang: string }> }) => {
  ...
  const jsonLd = buildCountryJsonLd({
    name: COUNTRIES_SEO.russia.title[lang],
    description: COUNTRIES_SEO.russia.description[lang],
    imageUrl: "/images/Russia.webp",
    pageUrl: `${SITE_URL}/${lang}/countries/russia`,
  });
  const heading =
    lang === "ar" ? "السفر إلى روسيا" : lang === "ru" ? "Путешествие в Россию" : "Travel to Russia";
  return (
