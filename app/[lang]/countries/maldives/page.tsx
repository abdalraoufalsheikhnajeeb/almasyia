...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/countries/maldives",
    title: COUNTRIES_SEO.maldives.title,
    description: COUNTRIES_SEO.maldives.description,
    imageUrl: "/images/Maldives.webp",
  });
}
...
const page = async ({ params }: { params: Promise<{ lang: string }> }) => {
  ...
  const jsonLd = buildCountryJsonLd({
    name: COUNTRIES_SEO.maldives.title[lang],
    description: COUNTRIES_SEO.maldives.description[lang],
    imageUrl: "/images/Maldives.webp",
    pageUrl: `${SITE_URL}/${lang}/countries/maldives`,
  });
  const heading =
    lang === "ar" ? "السفر إلى المالديف" : lang === "ru" ? "Путешествие на Мальдивы" : "Travel to Maldives";
  return (
