...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/countries/uae",
    title: COUNTRIES_SEO.uae.title,
    description: COUNTRIES_SEO.uae.description,
    imageUrl: "/images/uae.webp",
  });
}
...
const page = async ({ params }: { params: Promise<{ lang: string }> }) => {
  ...
  const jsonLd = buildCountryJsonLd({
    name: COUNTRIES_SEO.uae.title[lang],
    description: COUNTRIES_SEO.uae.description[lang],
    imageUrl: "/images/uae.webp",
    pageUrl: `${SITE_URL}/${lang}/countries/uae`,
  });
  const heading =
    lang === "ar" ? "السفر إلى الإمارات" : lang === "ru" ? "Путешествие в ОАЭ" : "Travel to UAE";
  return (
