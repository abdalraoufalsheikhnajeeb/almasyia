...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/tourismprogarams/egypt",
    title: TOURISM_PROGRAMS_SEO.egypt.title,
    description: TOURISM_PROGRAMS_SEO.egypt.description,
  });
}
...
const page = async ({ params }: { params: Promise<{ lang: string }> }) => {
  ...
  const jsonLd = buildTouristTripJsonLd({
    name: TOURISM_PROGRAMS_SEO.egypt.title[lang],
    description: TOURISM_PROGRAMS_SEO.egypt.description[lang],
    pageUrl: `${SITE_URL}/${lang}/tourismprogarams/egypt`,
  });
  return (
    <main className="container mx-auto  min-h-screen">
      ...
      />
      <h1 className="sr-only">{TOURISM_PROGRAMS_SEO.egypt.title[lang]}</h1>
