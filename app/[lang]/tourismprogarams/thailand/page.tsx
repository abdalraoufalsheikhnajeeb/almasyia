...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/tourismprogarams/thailand",
    title: TOURISM_PROGRAMS_SEO.thailand.title,
    description: TOURISM_PROGRAMS_SEO.thailand.description,
  });
}
...
const page = async ({ params }: { params: Promise<{ lang: string }> }) => {
  ...
  const jsonLd = buildTouristTripJsonLd({
    name: TOURISM_PROGRAMS_SEO.thailand.title[lang],
    description: TOURISM_PROGRAMS_SEO.thailand.description[lang],
    pageUrl: `${SITE_URL}/${lang}/tourismprogarams/thailand`,
  });
  return (
    <main className="container mx-auto  min-h-screen">
      ...
      />
      <h1 className="sr-only">{TOURISM_PROGRAMS_SEO.thailand.title[lang]}</h1>
