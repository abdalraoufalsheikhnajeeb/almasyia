...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/tourismprogarams/malaysia",
    title: TOURISM_PROGRAMS_SEO.malaysia.title,
    description: TOURISM_PROGRAMS_SEO.malaysia.description,
  });
}
...
const page = async ({ params }: { params: Promise<{ lang: string }> }) => {
  ...
  const jsonLd = buildTouristTripJsonLd({
    name: TOURISM_PROGRAMS_SEO.malaysia.title[lang],
    description: TOURISM_PROGRAMS_SEO.malaysia.description[lang],
    pageUrl: `${SITE_URL}/${lang}/tourismprogarams/malaysia`,
  });
  return (
    <main className="container mx-auto  min-h-screen">
      ...
      />
      <h1 className="sr-only">{TOURISM_PROGRAMS_SEO.malaysia.title[lang]}</h1>
