...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    lang: lang as Locale,
    path: "/tourismprogarams/turkey",
    title: TOURISM_PROGRAMS_SEO.turkey.title,
    description: TOURISM_PROGRAMS_SEO.turkey.description,
  });
}
...
const page = async ({ params }: { params: Promise<{ lang: string }> }) => {
  ...
  const jsonLd = buildTouristTripJsonLd({
    name: TOURISM_PROGRAMS_SEO.turkey.title[lang],
    description: TOURISM_PROGRAMS_SEO.turkey.description[lang],
    pageUrl: `${SITE_URL}/${lang}/tourismprogarams/turkey`,
  });
  return (
    <main className="container mx-auto  min-h-screen">
      ...
      />
      <h1 className="sr-only">{TOURISM_PROGRAMS_SEO.turkey.title[lang]}</h1>
